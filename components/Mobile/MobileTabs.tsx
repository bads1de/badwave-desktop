...
const MobileTabs = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[70px] bg-gradient-to-br from-[#121212] to-[#1a1a1a]  border-t border-[#303030]  flex items-center justify-center z-50">
